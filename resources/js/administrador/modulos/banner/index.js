$(function () {
  ...
  var cargaBannersLista = $('#listBannersPrint').DataTable({
    "serverSide": true,
    "processing": true,
    "dom": '<"row mx-0"'
    ...
    "ajax": {
      "url": "/administrador/banners/lista",
    ...
    "language": {
      ...
      "emptyTable": "No hay banners disponibles",
  ...
  $("#listBannersPrint").parent().addClass("table-responsive tableFixHead")

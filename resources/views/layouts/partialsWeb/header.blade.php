        ...
        <ul class="header__contact-items py-2">
          ...
          <li class="mx-2 margin-right-0 position-relative dropdown__cuenta-menu">
            ...
            <ul class="dropdown__cuenta-menu--list">
              ...
              <li class="py-1">
                <a href="{{ url('/cuenta/detalle-historial-pedido') }}">
                  <i class="fa fa-angle-double-right" aria-hidden="true"></i>
                  <span class="px-1">
              ...
              <div id="accordionMenuHeader" class="accordion">
                ...
                <div class="card">
                  ...
                  <div id="collapseSix" aria-labelledby="headingSix" data-parent="#accordionMenuHeader" class="collapse">
                    <div class="card-body">
                      <ul class="card-submenu">
                        <li><a href="{{ url('/sub-categoria-detalle') }}">Alimentacion</a></li>
                        <li><a href="{{ url('/sub-categoria-detalle') }}">Snacks y Huesos</a></li>
                        <li><a href="{{ url('/sub-categoria-detalle') }}">Juguetes</a></li>
                        <li><a href="{{ url('/sub-categoria-detalle') }}">Paseo</a></li>
                        <li><a href="{{ url('/sub-categoria-detalle') }}">En Casa</a></li>
                        <li><a href="{{ url('/sub-categoria-detalle') }}">Transporte y Viaje</a></li>
                        <li><a href="{{ url('/sub-categoria-detalle') }}">Entretenimiento</a></li>
                        <li><a href="{{ url('/sub-categoria-detalle') }}">Antiparasitarios</a></li>
                        <li><a href="{{ url('/sub-categoria-detalle') }}">Peluquería e Higiene</a></li>
                        <li><a href="{{ url('/sub-categoria-detalle') }}">Vitaminas y Suplementos</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <div class="header__navbar-sub-menu">
              <div class="row no-row row-cols-md-5 row-cols-lg-5 justify-content-center py-3">
                <div class="col py-3">
                  ...
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Pieso</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Comida Húmeda</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Snacks y Huesos</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Huesos</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Galletas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Snacks Dentales</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  ...
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Entretenimiento</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Educativos</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Mordedores y Dentales</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Paseo</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Bozales</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Collares</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Correas</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">En Casa</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Camas y Sofas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Casetas</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Transporte y Viaje</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Bolsos y Mochilas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Jaulas y Transportines</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Entretenimiento</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Clickers y Silbatos</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Arneses</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Antiparasitarios</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Collares antipulgas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Antiparasitarios</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  ...
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Champus y Colonias</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Cepillos y Cortapelos</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Vitaminas y Suplemento</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Vitaminas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Condroprotectores</a></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="header__navbar-sub-menu">
              <div class="row no-row row-cols-md-5 row-cols-lg-5 justify-content-center py-3">
                ...
                <div class="col py-3">
                  ...
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Jaleas Malta y Hierbas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Premios y Recompensas</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Arena Higiénicas</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Areneros y bandejas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Arenas Aglomerantes</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Arenas de Sílice</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Areneros Absorbentes</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Areneros Vegetales</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Juguetes</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Entretenimiento</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Rascadores</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Collares arneses y correas</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Arneses y Correas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Collares</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">En Casa</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Camas y mantas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Comederos y dispensadores</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Fuentes y bebederos</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Transporte y Viaje</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Mochilas y bolsas</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Transportines y Jaulas</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Comportamiento</a></p>
                  <ul class="text-left">
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Repelentes</a></li>
                    <li><a href="{{ url('/sub-categoria-detalle') }}">Comportamiento y Feromonas</a></li>
                  </ul>
                </div>
                <div class="col py-3">
                  <p class="header__navbar-sub-menu--titulo text-left"><a href="{{ url('/sub-categorias') }}">Peluquerias e Higiene</a></p>

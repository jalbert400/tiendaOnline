  ...
  var cargaRolesLista = $('#listRolesPrint').DataTable({
    ...
    "ajax": {
      ...
      "error": function error(jqXHR, textStatus) {
        ...
        erroresPeticion = erroresPeticion.trim() == 0 ? "hubo un error en el servicio, intente nuevamente." : erroresPeticion; //$("#body-errors-modal").html(`<div class="text-danger">${erroresPeticion}</div>`)
        //$('#errorsModal').modal('show')
...
module.exports = __webpack_require__(/*! C:\laragon\www\tiendaOnline\resources\js\administrador\modulos\role\index.js */"./resources/js/administrador/modulos/role/index.js");
